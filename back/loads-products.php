...
$output = "<ul style='background:lightyellow;border: 1px solid yellow;list-style: none;>'";
	...
	if(mysqli_num_rows($result) > 0){
		...
		$output .= "<a style='text-decoration:none;' href='item/{$row['slug']}'>
			<li  onclick='window.location.href='item/{$row['slug']}'' style='text-decoration:none;border-radius: 3px;padding:3px;color:#000;font-size:16px;'>{$row['name']} </li>
