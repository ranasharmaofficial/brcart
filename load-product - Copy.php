<?php
//52.77.62.21
$conn = mysqli_connect("localhost","root","","ubazar_db") or die(" ");
...
$output = "<ul style='background:lightyellow;border: 1px solid yellow;list-style: none;>'";
	...
	if(mysqli_num_rows($result) > 0){
		...
		$output .= "<a href=http://localhost/papa/item/{$row['slug']}>
			<li style='text-decoration:none;border-radius: 3px;padding:3px;color:#000;font-size:16px;'>{$row['name']} </li>
