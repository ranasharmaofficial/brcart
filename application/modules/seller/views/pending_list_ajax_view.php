		...
		<table class="table table-bordered"  width="100%" cellspacing="0">
			...
			if(is_array($getAllPendingOrder) && count($getAllPendingOrder) > 0){
				...
				<tr id="<?php echo $val['id']; ?>">
					...
					<td>
					<a href="<?php echo WEB_URL .'seller/orderdetails/' ?><?php echo $val['id']; ?>"><button type="submit" class="btn btn-danger btn-sm">Order&nbsp;Details</button></a></td>
					<td>
							...
							<?php if($val['deliverystatus']=='1') { ?>
								...
								<button onclick="window.location.href='<?php echo WEB_URL.'seller/updateDeclineStatus?id='.$val['order_id']; ?>'" style="background-color:#FFC733;" onclick="window.location.href='<?php echo WEB_URL.'seller/updatePendingStatus?id='.$val['order_id']; ?>'" type="button" class="btn btn-sm">
									Decline&nbsp;Order
								</button>
