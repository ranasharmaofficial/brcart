<div class="table-responsive">
    <div style="min-height: 250px;">
        <table class="table table-bordered" width="100%" cellspacing="0">
            ...
            <tbody>
                <?php
			if(is_array($getAllShippedOrder) && count($getAllShippedOrder) > 0){
				foreach($getAllShippedOrder as $val) {
				?>
                <tr id="<?php echo $val['id']; ?>">
                    ...
                    <td>
                        <a target="_blank"
                            href="<?php echo WEB_URL .'seller/orderdetails/' ?><?php echo $val['id']; ?>"><button
                                type="submit" class="btn btn-danger btn-sm">Order&nbsp;Details</button></a>
                    </td>
                    <td>
                        <div class="input-group-prepend">
                            <?php if($val['deliverystatus']=='1') { ?>
                            <button
                                onclick="window.location.href='<?php echo WEB_URL.'seller/updatePendingStatus?id='.$val['order_id']; ?>'"
                            ...
                            <button
                                onclick="window.location.href='<?php echo WEB_URL.'seller/updateShippedStatus?id='.$val['order_id']; ?>'"
