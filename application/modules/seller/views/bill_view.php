...
<title>Order No - <?php echo $details['order_no']; ?></title>
         ...
         <div class="card-body">
             <div class="row mb-4">
				<div style="margin-left:20px;" class="col-sm-12">
					...
					<p class="text-dark mb-1"><small>Invoice&nbsp;Date : <?php echo $details['order_date']; ?></small></p>
				</div>
                 <div class="col-sm-6 pt-2">
				  ...
				  <div class="col-sm-6 pt-2 ">
                     ...
                     <div>Address Type: <?php echo $details['address_type']; ?></div>
                     <div>Delivery Time: <?php echo $details['delivery_time']; ?></div>
                 </div>
				 <div class="col-sm-6 pt-3">
				 
                     
					 <?php if(!$details['gst']=='') { ?>
                     <div><strong>GST:&nbsp;</strong><?php echo $details['gst']; ?></div>
					 <?php } else { ?>
					 <?php }  ?>
                  </div><?php if(false) { ?>
				 <div class="col-sm-6 pt-3">
				 ...
				 <div class="col-sm-6 pt-3">
					 ...
					 <?php if($details['payment_mode']=='COD') { ?>
                     <div><strong>Collect Cash : </strong>Rs <?php echo getNumberFormat($details['delivery_charge']+$subTotal); ?></div>
					 <?php } ?>
                  </div>
				  <div class="col-sm-6 pt-3">
                 ...
                 <table class="table table-striped">
                     ...
                     <tbody>
                         <tr>
                             ...
                             <td class="right">Rs&nbsp;<?php echo getNumberFormat($details['previous_price']);?></td>
                             <?php if(false) { ?><td class="right">Rs&nbsp;<?php echo getNumberFormat($details['without_gst_price']);?></td>
                             <td class="center">Rs&nbsp;<?php echo getNumberFormat($details['qty']*$details['without_gst_price']); ?></td>
                             <td class="center"><?php echo $details['gst_percentage'];?>&nbsp;%</td>
                             <td class="center"><?php echo $details['gst_amount']*$details['qty'];?></td><?php } ?>
                              <td class="right">Rs&nbsp;<?php echo getNumberFormat($details['qty']*$details['product_price']) ;?></td>
                              <td class="right">Rs&nbsp;<?php echo getNumberFormat($details['previous_price']-$details['qty']*$details['product_price']) ;?></td>
							<?php $subTotal = $details['qty']*$details['product_price']; ?>
						</tr>
                     ...
                     <table class="table table-clear">
                         <tbody>
                             <tr>
                                 ...
                                 <td class="right">Rs&nbsp;<?php echo getNumberFormat($subTotal); ?></td>
                             </tr>
                             <tr>
                                 <td class="left">
                                     <strong class="text-dark">Delivery </strong>
                                 </td>
                                 <td class="right">Rs&nbsp;<?php echo getNumberFormat($details['delivery_charge']); ?></td>
                             </tr>
                             ...
                             <tr>
                                 ...
                                 <td class="right">
                                     <strong class="text-dark">Rs&nbsp;<?php echo getNumberFormat($details['delivery_charge']+$subTotal); ?></strong>
                                 </td>
                             </tr>
                         </tbody>
                     </table>
