            ...
            <div class="page-content">
                <div class="container">
                    <div class="login-popup">
					   ...
					   <br>
							...
							<div class="container">
				<div style="border:2px solid whitesmoke;padding:4px;" class="alert alert p-3 shadow-sm" role="alert">
				<p  style="color:#443C03;" class="font-weight-bold">Important Messsage !</p>
				<p>You indicated you are a new customer , but an account already exists with the mobile phone number.
				</br>
				<b>+91 <?php echo $this->session->userdata('session_mobile_no');?></b></p>
				</div>
				</div>
					   <?php } ?>
								...
								<form action="" method="post" >
                                    ...
                                    <div class="form-checkbox d-flex align-items-center justify-content-between">
                                        ...
                                        <a style="font-size:16px;" href="<?php echo WEB_URL.'users/forgotPassword'?>">Lost your password?</a>
                                    </div>
									<input type="hidden" name="ref" value="<?php if(isset($_GET['ref'])) { echo $_GET['ref']; } else { echo ''; } ?>">
                                    <div class="send-button">
										<input style="width:100%;height:40px;background-color:#007bff;border:1px solid #007bff;font-size:15px;color:#fff;font-weight:bold;"class="btn"  id="ubaazarlogin" type="submit" name="loginSubmit" value="LOGIN">
									</div>
				...
				<input type="hidden" name="ref" value="<?php if(isset($_GET['ref'])) { echo $_GET['ref']; } else { echo ''; } ?>">
									...
									<div class="form-group mb-5">
                                      ...
                                      <button style="width:100%;height:40px;background-color:#007bff;border:1px solid #007bff;font-size:15px;color:#fff;font-weight:bold;" type="submit" value="submit" name="registerSubmit" class="btn">Sign Up</button>
                                </div>
						</form>	
