 ...
 <!-- Start of PageContent -->
    ...
    <div class="regisFrm">
        ...
        <p><b>Gender: </b><?php echo $seller['gender']; ?></p>
                                ...
                                <div class="row p-6">
								 <?php
				if(is_array($sellerSubscriptionList) && count($sellerSubscriptionList) > 0) {
					foreach ($sellerSubscriptionList as $val) {
						?>
                                     
										<div class="columns  mb-4">
										  <ul style="border:2px solid #04AA6D;" class="price">
											<li class="header" style="background-color:#04AA6D"><?php echo $val['title']; ?></li>
											<li class="grey"><?php echo $val['currency']; ?> <?php echo $val['price']; ?></li>
											<li><strong>Day:&nbsp;</strong><?php echo $val['days']; ?></li>
											<li><?php echo $val['details']; ?></li>
											<li><strong>Products&nbsp;Allowed:&nbsp;</strong><?php if($val['allowed_products']=='0') { ?> USE UNLIMITED <?PHP } else { ?> <?php echo $val['allowed_products']; ?> <?php } ?></li>
											<li class="grey"><a href="<?php echo WEB_URL.'users/subscription/' ?><?php echo encrypt_url($val['id']); ?>" class="button">GET&nbsp;STARTED</a></li>
										  </ul>
										</div>
