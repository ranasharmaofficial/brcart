...
<hr>
			...
			<?php if ($val['delivery_status']=='1' || $val['delivery_status']=='2' || $val['delivery_status']=='3') { ?>
				<hr>
				
				<div onclick="window.location.href='<?php echo WEB_URL .'users/cancelorder/' ?><?php echo encrypt_url($val['id']); ?>'" style="cursor:pointer;" class="row">						
					<div class="col-12">
