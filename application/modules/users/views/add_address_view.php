            ...
            <div class="tab tab-vertical row gutter-lg p-2">
                ...
                <div class="tab-content mb-6">
                    ...
                    <div class="tab-pane active in" id="account-addresses">
                        ...
                        <?php $this->load->view('adminlayout/message_view');?>
                        <div class="container">
                            <h4 style="" class="font-weight-bold">Add a New Address</h4>
                            <hr>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input required style="font-size:16px;" type="text"
                                                value="<?php echo $userrow['first_name'] . ' ' . $userrow['last_name']; ?>"
                                                id="firstname" name="name" class="form-control form-control-md">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input required type="text" value="<?php echo $userrow['mobile_no']; ?>" id="Mobile"
                                                name="mobile" style="font-size:16px;"
                                                class="form-control form-control-md">
                                            <?php echo form_error('mobile'); ?>
                                        </div>
                                    </div>
                                    <input type="hidden" required name="user_id" value="<?php echo $userId; ?>">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="Pin">Pin Code *</label>
                                            <input required type="text" value="<?php echo set_value('pin'); ?>" id="pincode"
                                                name="pin" class="form-control form-control-md" style="font-size:16px;">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input required onclick="get_details()" type="text" value="<?php echo set_value('house_no'); ?>" id="Flat" name="house_no" class="form-control form-control-md" style="font-size:16px;">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="Area" value="<?php echo set_value('address'); ?>"
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="Area" value="<?php echo set_value('landmark'); ?>"
									...
									<div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="state" value="<?php echo set_value('state'); ?>"
									...
									<div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="city" value="<?php echo set_value('city'); ?>"
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select style="font-size:16px;" type="combobox" id="example-email"
                                                name="address_type" required class="form-control">
                                                <option value="Home">Home</option>
                                                <option value="Office">Office</option>
                                                <option value="Sister Address">Sister Address</option>
                                                <option value="Brother Address">Brother Address</option>
                                                <option value="Friend Address">Friend Address</option>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <button type="submit" name="submit" value="submit" class="btn btnaddress"
                                                style="background: #FFD814;border-color: #FCD200;font-size:15px;">Add
                                                Address</button>
                                        </div>
                                    </div>
                                </div>
...
<script>
	...
	if(pincode==''){
		...
		jQuery.ajax({
			url:'<?php echo base_url("users/getPinDetails")?>',
			type:'post',
