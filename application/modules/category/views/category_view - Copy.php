				...
				if(is_array($productsbycategory) && count($productsbycategory) > 0) {
					...
					<nav>
                     <ul class="pagination justify-content-center mt-4">
						<li class="page-item"><a class="page-link" href="?cat=<?php echo $_GET['cat']?>&subcat=<?php if(isset($_GET['subcat'])) { echo $_GET['subcat']; }?>&childcat=<?php if(isset($_GET['childcat'])) { echo $_GET['childcat']; }?>&pageno=1">First</a></li>
