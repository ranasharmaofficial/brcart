                        ...
                        <center>
                            <nav style="text-align:center;">
                                <ul class=" pagination mt-4">
                                    <li onclick="window.location.href='?pageno=1&cat=<?php echo $_GET['cat']; ?><?php if (isset($_GET['subcat'])) {?>&subcat=<?php if (isset($_GET['subcat'])) {echo $_GET['subcat'];}}?><?php if (isset($_GET['childcat'])) {?>&childcat=<?php if (isset($_GET['childcat'])) {echo $_GET['childcat'];}}?>'"
                                        class="page-item"><a class="page-link current_page"
                                            href="?pageno=1&cat=<?php echo $_GET['cat']; ?><?php if (isset($_GET['subcat'])) {?>&subcat=<?php if (isset($_GET['subcat'])) {echo $_GET['subcat'];}}?><?php if (isset($_GET['childcat'])) {?>&childcat=<?php if (isset($_GET['childcat'])) {echo $_GET['childcat'];}}?>">First</a>
                                    </li>
                                    <li onclick="window.location.href='<?php if ($pageno <= 1) {echo '#';} else {echo "?pageno=" . ($pageno - 1);}?>&cat=<?php echo $_GET['cat']; ?><?php if (isset($_GET['subcat'])) {?>&subcat=<?php if (isset($_GET['subcat'])) {echo $_GET['subcat'];}}?><?php if (isset($_GET['childcat'])) {?>&childcat=<?php if (isset($_GET['childcat'])) {echo $_GET['childcat'];}}?>'"
                                        class="page-item <?php if ($pageno <= 1) {echo 'disabled';}?>">
                                        <a class="page-link "
                                            href="<?php if ($pageno <= 1) {echo '#';} else {echo "?pageno=" . ($pageno - 1);}?>&cat=<?php echo $_GET['cat']; ?><?php if (isset($_GET['subcat'])) {?>&subcat=<?php if (isset($_GET['subcat'])) {echo $_GET['subcat'];}}?><?php if (isset($_GET['childcat'])) {?>&childcat=<?php if (isset($_GET['childcat'])) {echo $_GET['childcat'];}}?>">Previous</a>
                                    </li>
                                    <li onclick="window.location.href='<?php if ($pageno >= $total_pages) {echo '#';} else {echo "?pageno=" . ($pageno + 1);}?>&cat=<?php echo $_GET['cat']; ?><?php if (isset($_GET['subcat'])) {?>&subcat=<?php if (isset($_GET['subcat'])) {echo $_GET['subcat'];}}?><?php if (isset($_GET['childcat'])) {?>&childcat=<?php if (isset($_GET['childcat'])) {echo $_GET['childcat'];}}?>'"
                                        class="page-item <?php if ($pageno >= $total_pages) {echo 'disabled';}?>">
                                        <a class="page-link"
                                            href="<?php if ($pageno >= $total_pages) {echo '#';} else {echo "?pageno=" . ($pageno + 1);}?>&cat=<?php echo $_GET['cat']; ?><?php if (isset($_GET['subcat'])) {?>&subcat=<?php if (isset($_GET['subcat'])) {echo $_GET['subcat'];}}?><?php if (isset($_GET['childcat'])) {?>&childcat=<?php if (isset($_GET['childcat'])) {echo $_GET['childcat'];}}?>">Next</a>
                                    </li>
                                    <li onclick="window.location.href='?pageno=<?php echo $total_pages; ?>&cat=<?php echo $_GET['cat']; ?><?php if (isset($_GET['subcat'])) {?>&subcat=<?php if (isset($_GET['subcat'])) {echo $_GET['subcat'];}}?><?php if (isset($_GET['childcat'])) {?>&childcat=<?php if (isset($_GET['childcat'])) {echo $_GET['childcat'];}}?>'"
                                        class="page-item"><a class="page-link"
                                            href="?pageno=<?php echo $total_pages; ?>&cat=<?php echo $_GET['cat']; ?><?php if (isset($_GET['subcat'])) {?>&subcat=<?php if (isset($_GET['subcat'])) {echo $_GET['subcat'];}}?><?php if (isset($_GET['childcat'])) {?>&childcat=<?php if (isset($_GET['childcat'])) {echo $_GET['childcat'];}}?>">Last</a>
                                    </li>
                                </ul>
                            </nav>
                        </center>
