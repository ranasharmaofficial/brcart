...
class Category_model extends MY_Model
{
    ...
    public function getCategoryDetailsRows($params = array())
    {
    ...
    public function getAllProductas($cat)
    {
        $result = array();
        $fields = "a.*";
        $this->db->select($fields);
    ...
    public function NestedProducts($offset = null)
    {
...
// else
    ...
    public function fetch_category($type)
    {
        $this->db->select($type);
