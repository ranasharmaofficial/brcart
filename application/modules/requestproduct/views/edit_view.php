<div id="layoutSidenav_content">
	<main>
		<div class="container-fluid">
			...
			<div class="card mb-4">
				<div class="card-body">
					<form method="post" action="<?php echo WEB_URL.'product/edit?id='.$row['id'];?>" enctype="multipart/form-data">
						<input type="hidden" name="id" value="<?php echo $row['id'];?>">
						<div class="form-row">
							<div class="col-md-4">
								<div class="form-group">
									<label class="medium mb-1" for="name">Product Name <star>*</star></label>
									<input class="form-control" value="<?php echo $row['name']; ?>" id="name" type="text" placeholder="Enter product name" name="name"/>
						...
						<div class="form-row">
							<div class="form-group mt-4 mb-0">
								...
								<a href="<?php echo WEB_URL.'product/all';?>" class="btn btn-danger btn-sm" >Reset</a>
							</div>
						</div>
					</form>
				</div>
