  ...
  <div class="content-wrapper">
    ...
    return substr(str_shuffle(str_repeat($x='0123456789ABCDEFGHIJKLMNOPQRSTVWXYZ', ceil($length/strlen($x)) )),1,$length);
			...
			<div class="form-group">
			<p  for="subject">Select Subcategory <star>*</star></p>
			...
			<div class="form-group">
			<p for="subject">Select Child Category <star>*</star></p>
				<!-- City dropdown -->
			...
			<div class="form-group">
				...
				<?php echo form_error('ship'); ?>
				 ...
				 <div class="form-group">
					 <p for="Shipping">Product Stock <small>(Leave Empty will Show Always Available)</small></p>
					 <input class="form-control" value="<?php echo set_value('stock'); ?>" id="Shipping" type="text" placeholder="Product Stock" name="stock"/>
				 </div>
				 <?php if(false) {  ?>
				<div class="form-group">
				...
				<div class="form-group">
					...
					<div style="display:none;" class="1 box">
						<div class="form-group">
							...
							<input class="form-control" value="<?php echo set_value('whole_sell_qty'); ?>" id="BlogCategory" type="text" placeholder="Enter Meta Tags" name="meta_tag"/>
						</div>
						<div class="form-group">
							<p for="BlogCategory">Meta Description</p>
							<input class="form-control" value="<?php echo set_value('whole_sell_qty'); ?>" id="BlogCategory" type="text" placeholder="Enter Meta Description" name="meta_description"/>
						</div>
					</div>
				</div>
...
$('#summernote').summernote({
	...
	height: 150
				 ...
				 <p class="mb-1" for="Shipping">Select COD Available</p><br>
					<div class="form-group container form-row">
					  ...
					  <div class="custom-control custom-radio col-4">
							  <input class="custom-control-input" value='1' type="radio" id="customRadio1" name="cod_available">
							  <label for="customRadio1" class="custom-control-label">Yes</label>
					  </div>
					  <div class="custom-control custom-radio col-4">
						  <input class="custom-control-input" value="2" type="radio" id="customRadio2" name="cod_available">
                ...
                <div class="card-footer text-right">
                  <button type="submit" name="submit" value="submit" class="btn btn-sm btn-warning">Add&nbsp;Product</button>
                </div>
              </form>
            </div>
            <!-- /.card -->
                 ...
                 <div class="form-group">
				  ...
				  <div class="form-group">
				   ...
				   <div class="form-group">
					...
					<div class="form-group">
						<p for="BlogCategory">GST Percentage <star>*</star></p>
				  ...
				  <?php if(false) {  ?>
				<div class="form-group">
						<p for="BlogCategory">Delivery Charge Pay By <star>*</star></p>
				  ...
				  <div class="form-group">
					  ...
					  <input class="form-control" value="<?php echo set_value('previous_price'); ?>" id="BlogCategory" type="text" placeholder="Enter MRP" name="previous_price"/>
