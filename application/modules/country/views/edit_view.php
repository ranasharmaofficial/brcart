					...
					<form method="post" action="">
						...
						<div class="form-row">
							<div class="col-md-4">
								<div class="form-group">
									<label class="small mb-1" for="name">Country Name <star>*</star></label>
									<input class="form-control" value="<?php echo $row['name']; ?>" id="name" type="text" placeholder="Enter Country name" name="name"/>
						...
						<div class="form-row">
							<div class="form-group mt-4 mb-0">
								...
								<a href="<?php echo WEB_URL.'country/all';?>" class="btn btn-danger btn-sm" >Reset</a>
							</div>
						</div>
					</form>
				</div>
