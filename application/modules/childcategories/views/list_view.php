      ...
      <div class="card card-primary">
        <div class="card-header">
          ...
          <div class="card-tools">
           <a href="<?php echo WEB_URL.'childcategories/add';?>" class="btn btn-sm btn-danger">Add Child Category</a>
          </div>
        </div>
		<div class="card-body">
					<div class="row">
...
<script>
		...
		function categoryList(page_url)
		{
			...
			base_url = base_url+"childcategories/get_childcategory_ajax_list";
