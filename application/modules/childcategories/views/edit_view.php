        ...
        <div class="card-body row">
			 ...
			 <input type="hidden" name="id" value="<?php echo $row['id']; ?>">
				...
				<p for="subject">Select Category <star>*</star></p>
					<!-- Country dropdown -->
				<?php echo form_dropdown('category_id',$CategoryName,'','class="form-control" id="category"');
					?>
				...
				<p for="Childcategory">Enter Child Category <star>*</star></p>
					<input type="text" name="name" value="<?php echo $row['name'];?>" class="form-control" id="Childcategory">
				</div>
              
				<div class="form-group text-right">
					<button type="reset" class="btn btn-danger" >Reset</button>
					<button type="submit" name="submit" value="submit" class="btn btn-info" >Edit</button>
				</div>
            </div>
			<div class="col-sm-2"></div>
        </div>
