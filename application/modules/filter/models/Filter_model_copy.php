									...
									<center>
                                        <figure class="product-media">
                                            ...
                                            <div class="product-action-horizontal">
											 ...
											 if($countSellerProduct>=1) {   
											 if('.$row['previous_price'].'>'.$sellerProductPrice.') {  
                                        <div class="product-label-group">
                                            <label class="product-label label-discount">
												 if(round((('.$row['previous_price'].'-'.$sellerProductPrice.')*(100/'.$row['previous_price'].')),0)>="0") { 
												 round((('.$row['previous_price'].'-'.$sellerProductPrice.')*(100/'.$row['previous_price'].')),0)   
												 }
												</label>
                                        </div>
											 } 
										...
										<div class="product-label-group">
                                            <label class="product-label label-discount">
												  if(round((('.$row['previous_price'].'-'.$row['price'].')*(100/'.$row['previous_price'].')),0)>="0") {  
												  echo round((('.$row['previous_price'].'-'.$row['price'].')*(100/'.$row['previous_price'].')),0)  
												   }   
												</label>
                                        </div>
										   }  }   
