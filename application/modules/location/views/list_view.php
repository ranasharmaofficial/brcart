<div id="layoutSidenav_content">
		...
		<div class="container-fluid">
			<div class="page-title-header mb-4">
				<div class="row">
					...
					<div class="col-sm-2 text-right"><a href="<?php echo WEB_URL.'location/add';?>" class="btn btn-sm btn-primary">Add Location</a> </div>
				</div>
			</div>
			<div class="card mb-4">
				<div class="card-body">
					<div class="row">
						<div class="col-sm-6">
							<input type="text" class="form-control" name="search_key" id="search_key" placeholder="By Location" />
						</div>
						<div class="col-sm-3">
	...
	<script>
		...
		function categoryList(page_url)
		{
			...
			base_url = base_url+"location/get_location_ajax_list";
