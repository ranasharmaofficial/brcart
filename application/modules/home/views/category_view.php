    ...
    <div id="nt_content">
        ...
        <div class="kalles-section page_section_heading">
            <div class="page-head tc pr oh cat_bg_img page_head_">
                <div class="parallax-inner nt_parallax_false lazyload nt_bg_lz pa t__0 l__0 r__0 b__0" data-bgset="<?php echo WEB_PATH_FRONT; ?>images/shop/shop-banner.jpg"></div>
                                            ...
                                            <ul class="nt_filter_block nt_filter_color css_ntbar" data-filter_condition="and">
                                                ...
                                                <li>
                                                    <a href="#" aria-label="Narrow selection to products matching tag color white cream">
                                                        <div class="filter-swatch">
                                                            <span class="swatch__value bg_color_white-cream lazyload" data-bg="<?php echo WEB_PATH_FRONT; ?>images/shop/color-white-cream.jpg"></span>
                                                        </div>
                                                        white cream</a>
                                                </li>
                                                <li>
                ...
                <div class="col-lg-12 col-12">
                    <div class="kalles-section tp_se_cdt">
                        ...
                        <div class="on_list_view_false products nt_products_holder row fl_center row_pr_1 cdt_des_1 round_cd_false nt_cover ratio_nt position_8 space_30 nt_default">
                            <?php
				if(is_array($productByCategory) && count($productByCategory) > 0) {
					foreach ($productByCategory as $val) {
						?>
