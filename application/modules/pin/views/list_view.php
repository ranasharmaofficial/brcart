      ...
      <div class="card card-primary">
        <div class="card-header">
          ...
          <div class="card-tools">
           <a href="<?php echo WEB_URL.'pin/add';?>" class="btn btn-sm btn-danger">Add Pin</a>
          </div>
        </div>
		<div class="card-body">
					<div class="row">
						<div class="col-sm-6">
							<input type="text" class="form-control" name="search_key" id="search_key" placeholder="By Pin" />
						</div>
						<div class="col-sm-3">
...
<script>
		...
		function categoryList(page_url)
		{
			...
			base_url = base_url+"pin/get_pin_ajax_list";
