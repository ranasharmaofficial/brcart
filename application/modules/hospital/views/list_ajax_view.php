<div class="table-responsive">
    <div style="min-height: 250px;">
        <table class="table table-hover table-bordered table-sm" width="100%" cellspacing="0">
            ...
            <tbody>
                <?php
			if(is_array($getAllHospitals) && count($getAllHospitals) > 0){
				foreach($getAllHospitals as $val) {
				?>
                <tr id="<?php echo $val['subcategory_id']; ?>">
                    <td><?php echo $val['category_name']; ?></td>
                    <td><?php echo $val['subcategory_name']; ?></td>
                     <td><a href="<?php echo WEB_URL.'hospital/edit?id='.$val['subcategory_id'];?>"
...
$(".remove").click(function() {
    ...
    swal({
        ...
        function(isConfirm) {
            ...
            base_url = base_url + "hospital/delete/" + id;
