			  ...
			  <input type="hidden" name="id" value="<?php echo $row['id'];?>">
                <div class="card-body">
                 <div class="form-group">
					...
					<input class="form-control" value="<?php echo $row['short_title']; ?>" id="subject" type="text" placeholder="Enter short title" name="short_title"/>
					<?php echo form_error('short_title'); ?>
				</div>
				<div class="form-group">
					<p for="subject">Long Title <star>*</star></p>
					<input class="form-control" value="<?php echo $row['long_title']; ?>" id="subject" type="text" placeholder="Enter long title" name="long_title"/>
					<?php echo form_error('long_title'); ?>
				</div>
				<div class="form-group">
					<p for="subject">Sale Discount <small>in Number</small> <star>*</star></p>
					<input class="form-control" value="<?php echo $row['sale_discount']; ?>" id="subject" type="text" placeholder="Enter sale discount" name="sale_discount"/>
					<?php echo form_error('sale_discount'); ?>
				</div>
				<div class="form-group">
					<p for="subject">Page Link <star>*</star></p>
					<input class="form-control" value="<?php echo $row['link']; ?>" id="subject" type="text" placeholder="Enter Link" name="link"/>
					<?php echo form_error('link'); ?>
				</div>
				<div class="form-group">
					<p for="subject">Text Color <star>*</star>&nbsp;<div style="height:20px;width:20px;background-color:<?php echo $row['text_color']; ?>;"></div></p>
            ...
            <div class="card card-success">
              ...
              <div class="card-body">
                 <div class="form-group">
                    ...
                    <input onchange="loadFile(event)" required name="sliderfile" type="file" class="form-control" id="exampleInputFile">
				</div>
				  <div class="form-group">
				  ...
				  <div class="form-group">
                    ...
                    <hr>
                      <img style="height:80px;" src="<?php echo WEB_ATTACHMENT_PATH; ?><?php echo $row['slider_pic']; ?>" class="img-thumbnail"/>
