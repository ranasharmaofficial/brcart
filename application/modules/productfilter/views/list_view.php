      ...
      <div class="card card-primary">
        <div class="card-header">
          ...
          <div class="card-tools">
           <a href="<?php echo WEB_URL.'productfilter/add';?>" class="btn btn-sm btn-danger">Add Category</a>
          </div>
        </div>
		<div class="card-body">
					<div class="row">
						<div class="col-sm-6">
							<input type="text" class="form-control" name="search_key" id="search_key" placeholder="By Category" />
						</div>
						<div class="col-sm-3">
...
<script>
		...
		function categoryList(page_url)
		{
			...
			//base_url = "http://localhost/papa/productfilter/get_productfilter_ajax_list";
			//base_url = base_url+"productfilter/get_productfilter_ajax_list";
			...
			$.ajax({
				type:"POST",
				url:"http://localhost/papa/productfilter/get_productfilter_ajax_list",
				data: dataString,
