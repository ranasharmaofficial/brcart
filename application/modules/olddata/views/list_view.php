<div id="layoutSidenav_content">
		...
		<div class="container-fluid">
			<div class="page-title-header mb-4">
				<div class="row">
					...
					<div class="col-sm-2 text-right"><a class="btn btn-sm btn-info"href="<?php echo WEB_URL.'olddata/add'?>">Add</a></div>
				</div>
			</div>
			<div class="card mb-4">
				<div class="card-body">
	...
	<script>
		...
		function subjectList(page_url)
		{
			...
			base_url = base_url+"olddata/getall_olddata_ajax_list";
...
<script>
		...
		$(document).on("click",".delete-btn", function(){
			if(confirm("Do you really want to delete this record ?")){
				...
				var element = this;
				var base_url = $('meta[name="weburl"]').attr('content');
				base_url = base_url+"olddata/deleteSingleData";
				//alert(studentId);
				$.ajax({
					url: base_url,
					type : "POST",
