            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="<?php echo WEB_URL.'dashboard/myDashboard' ?>">Home-
                                <?php echo $this->uri->segment(3); ?></a></li>
                        <li class="breadcrumb-item active">
                            <?php echo (isset($pvalue['page_heading']))?$pvalue['page_heading']:'';?></li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
        ...
        <div class="card card-primary">
            <div class="card-header">
                ...
                <div class="card-tools">
                    <a href="<?php echo WEB_URL.'distributor/addapplication';?>" class="btn btn-sm btn-danger">Add
                        Application</a>
                </div>
            </div>
            <div class="card-body">
                    ...
                    <div style="min-height: 250px;">
                        <table class="table table-bordered" width="100%" cellspacing="0">
                            ...
                            <tbody>
                                ...
                                <?php if (count($getDeathApplicationList)): 
			 $s=1;
			 ?>
                                <?php foreach ($getDeathApplicationList as $val): ?>
                                    ...
                                    <td>
                                        ...
                                        <form method="post" action="" enctype="multipart/form-data">
                                            ...
                                            <script src="https://checkout.razorpay.com/v1/checkout.js"
                                                ...
                                                data-amount="<?= $val['amount']; ?>00" data-buttontext="Pay Now"
                                                data-name="Sharma Telecom" data-description="Pay Registration Fee"
                                                data-image="" data-prefill.name="<?= $this->distributorName; ?>"
                                                data-prefill.contact="8825171386" data-prefill.email="cgcgfc@gmail.com"
                                                data-theme.color="#251564">
                                            </script>
                                        </form>
                                        <hr>
                                        <a href="<?php echo WEB_URL.'distributor/viewDetails?id='.$val['id'];?>"><button
                                                class="btn btn-primary btn-sm"><i
                                                    class="fa fa-eye">&nbsp;</i></button></a>
                                        <?php } else if($val['payment_status']=='2') { ?>
                                        <button class="btn btn-success btn-sm">In&nbsp;Process</button>
                                        <hr>
                                        <a href="<?php echo WEB_URL.'distributor/viewDetails?id='.$val['id'];?>"><button
                                                class="btn btn-primary btn-sm"><i
                                                    class="fa fa-eye">&nbsp;</i></button></a>
                                        ...
                                        <a href="<?php echo base_url();?>dob_application/<?= $val['dob_certificate']; ?>"
                                            download><button
                                                class="btn btn-info btn-sm">Download&nbsp;Certificate</button></a>
                                        <a href="<?php echo WEB_URL.'distributor/viewDetails?id='.$val['id'];?>"><button
                                                class="btn btn-primary btn-sm"><i
                                                    class="fa fa-eye">&nbsp;</i></button></a>
                                        <?php } ?>
