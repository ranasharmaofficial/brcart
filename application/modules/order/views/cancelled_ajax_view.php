	...
	<div style="min-height: 250px;">
		<table class="table table-bordered"  width="100%" cellspacing="0">
			...
			if(is_array($getAllCancelledOrder) && count($getAllCancelledOrder) > 0){
				...
				<button onclick="window.location.href='<?php echo WEB_URL.'order/updateShippedStatus?id='.$val['order_id']; ?>'" type="button" class="btn btn-info btn-sm">
									Order&nbsp;Shipped
								</button>
				...
				<button onclick="window.location.href='<?php echo WEB_URL.'order/updateCancellationStatus?id='.$val['order_id']; ?>'" type="button" class="btn btn-info btn-sm">
									Requested&nbsp;Cancel
								</button>
