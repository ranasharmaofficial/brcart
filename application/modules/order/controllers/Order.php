...
class Order extends Admincontroller
{
    ...
    public function cancelRequestOrder()
    {
    ...
    {
        $data['getAllCodOrder'] = array();
        $data['pvalue'] = array('view' => 'cod_order_list_view', 'page_heading' => 'COD Order');
        $this->loadView($data);
    }
    
	public function onlineOrder()
    {
        $data['getAllOnlineOrder'] = array();
        $data['pvalue'] = array('view' => 'online_order_view', 'page_heading' => 'Online Order');
        $this->loadView($data);
    }
	...
	public function billdetails($id)
    {
        ...
        $this->load->view('bill_details_view', $data);

    }
    public function updatePendingStatus($postVal = array())
    {
...
// curl_setopt($ch, CURLOPT_POSTFIELDS, "username=ubaazar&password=283363&sender=UBZAAR&sendto=".$phones."&message=".$msg."&PEID=1001541570000044395&templateid=1007163832885535095");
    ...
    public function updateDeclineStatus($postVal = array())
    {
        $response = array('status' => STATUS_FAIL, 'msg' => PLEASE_TRY_AGAIN);
        $pid = $_GET['id'];
        $data = array(
...
// curl_setopt($ch, CURLOPT_POSTFIELDS, "username=ubaazar&password=283363&sender=UBZAAR&sendto=".$phones."&message=".$msg."&PEID=1001541570000044395&templateid=1007163832885535095");
        ...
        redirect('order/cancelledOrder?i=' . $customer_Mobile);
        return $response;
    }

    public function updateApprovedStatus($postVal = array())
    {
        $response = array('status' => STATUS_FAIL, 'msg' => PLEASE_TRY_AGAIN);
        $pid = $_GET['id'];
        $data = array(
    ...
    public function updateShippedStatus($postVal = array())
    {
        $response = array('status' => STATUS_FAIL, 'msg' => PLEASE_TRY_AGAIN);
        $pid = $_GET['id'];
        $data = array(
 ...
 Regards – UBaazar";
    ...
    public function updateCancellationStatus($postVal = array())
    {
        $response = array('status' => STATUS_FAIL, 'msg' => PLEASE_TRY_AGAIN);
        $pid = $_GET['id'];
        $data = array(
...
Regards - New Microsoet Computer';
    ...
    public function get_brand_ajax_list($offset = null)
    {
        $search = array(
    ...
    public function get_pending_ajax_list($offset = null)
    {
        $search = array(
            'keyword' => trim($this->input->post('search_key')),
        );
    ...
    public function get_approved_ajax_list($offset = null)
    {
        $search = array(
            'keyword' => trim($this->input->post('search_key')),
        );
    ...
    public function get_shipped_ajax_list($offset = null)
    {
        $search = array(
            'keyword' => trim($this->input->post('search_key')),
        );
    ...
    public function get_delivered_ajax_list($offset = null)
    {
        $search = array(
            'keyword' => trim($this->input->post('search_key')),
        );
    ...
    public function get_cancel_request_ajax_list($offset = null)
    {
        $search = array(
            'keyword' => trim($this->input->post('search_key')),
        );
    ...
    public function get_cancelled_ajax_list($offset = null)
    {
        $search = array(
            'keyword' => trim($this->input->post('search_key')),
        );
    ...
    public function get_cod_order_ajax_list($offset = null)
    {
        $search = array(
            'keyword' => trim($this->input->post('search_key')),
        );
        ...
        $offset = ($this->uri->segment(3)) ? $this->uri->segment(3) : 0;
        $postVal = array('limit' => $limit, 'offset' => $offset, 'searchVal' => $search, 'count' => true);
        $config['base_url'] = WEB_URL . 'order/get_cod_order_ajax_list';
        $config['total_rows'] = $this->order_model->getAllCodOrder($postVal);
        $config['per_page'] = $limit;
        $config['uri_segment'] = 3;
        $config['num_links'] = 3;
        $config['num_tag_open'] = '<li>';
        ...
        $data['pagelinks'] = $this->pagination->create_links();
        $postVal['count'] = false;
        $data['getAllCodOrder'] = $this->order_model->getAllCodOrder($postVal);
        $this->load->view('cod_order_list_ajax', $data);
    }
	public function get_online_order_ajax_list($offset = null)
    {
        $search = array(
            'keyword' => trim($this->input->post('search_key')),
        );
        ...
        $offset = ($this->uri->segment(3)) ? $this->uri->segment(3) : 0;
        $postVal = array('limit' => $limit, 'offset' => $offset, 'searchVal' => $search, 'count' => true);
        $config['base_url'] = WEB_URL . 'order/get_online_order_ajax_list';
        $config['total_rows'] = $this->order_model->getAllOnlineOrder($postVal);
        $config['per_page'] = $limit;
        $config['uri_segment'] = 3;
        $config['num_links'] = 3;
        $config['num_tag_open'] = '<li>';
        ...
        $data['pagelinks'] = $this->pagination->create_links();
        $postVal['count'] = false;
        $data['getAllOnlineOrder'] = $this->order_model->getAllOnlineOrder($postVal);
        $this->load->view('online_order_list_ajax', $data);
    }
